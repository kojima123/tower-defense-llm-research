#!/usr/bin/env python3
"""
Flask server for Tower Defense LLM Trainer - Real LLM Integration with Environment Variables
Handles OpenAI GPT integration using environment variables
"""
...
def index():
    ...
    <p>OpenAI API Key configured: """ + str(bool(os.getenv('OPENAI_API_KEY'))) + """</p>
...
def call_openai_api(prompt):
    ...
    try:
        ...
        print(f"Calling OpenAI API with key: {api_key[:20]}...")
...
"""
        ...
        if llm_response:
            ...
            print("LLM response failed, falling back to rule-based")
            # Fallback to rule-based guidance
            return get_rule_based_guidance(game_state)
...
if __name__ == '__main__':
    print("Starting Tower Defense LLM Trainer with environment variable support...")
