#!/usr/bin/env python3
"""
Flask server for Tower Defense LLM Trainer - Lightweight LLM Integration
Handles OpenAI GPT integration using simple HTTP requests
"""
...
if __name__ == '__main__':
    print("Starting Tower Defense LLM Trainer with lightweight LLM integration...")
